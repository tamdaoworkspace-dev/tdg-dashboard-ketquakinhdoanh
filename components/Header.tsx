  ...
  return (
    <div className="flex items-center justify-between flex-wrap gap-3 mb-6">
      <div className="flex items-center gap-3">
        <div className="w-11 h-11 rounded-full bg-gradient-to-br from-tdg-accent-soft to-tdg-accent-dark
             flex items-center justify-center text-white font-bold shadow-ios-lg">TĐ</div>
        <div>
      ...
      <div className="text-right">
        ...
        <div className="text-tdg-secondary text-[11px]">Build {new Date(updatedAt).toLocaleString("vi-VN")}</div>
      </div>
    </div>
  );
}
